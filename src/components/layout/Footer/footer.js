            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img class="w-auto h-auto" src="https://mogi.vn/content/Images/logo.svg" alt="" />

                        <p class="text-base leading-relaxed text-gray-600 mt-7">Chúng tôi cung cấp nhiều loại phòng đa dạng để bạn lựa chọn. Hãy thăm website của chúng tôi ngay hôm nay!</p>
                ...
                <p class="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by RoomRental</p>
            </div>
        </section>
